...
namespace Capenexislearners2023.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public CoursesController(Capenexislearners2023Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CoursesId,CoursesName,CoursesDescription,FacilitatorName")] Courses courses)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("CoursesId,CoursesName,CoursesDescription,FacilitatorName")] Courses courses)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(long id)
        {
            ...
            {
                return Problem("Entity set 'Capenexislearners2023Context.Courses'  is null.");
            }
            var courses = await _context.Courses.FindAsync(id);
            if (courses != null)
            {
